...
const BooksAndFeatures = () => {
  return (
    <section id="expertise" className="py-32 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          ...
          >
            <div className="relative w-full max-w-[320px] aspect-[3/4] bg-gradient-to-br from-[#0a192f] to-[#000d21] rounded-r-lg rounded-l-sm shadow-2xl overflow-hidden border-y-4 border-r-4 border-white/5 transform -rotate-3 hover:rotate-0 transition-transform duration-500 flex flex-col items-center justify-center p-8 text-center">
