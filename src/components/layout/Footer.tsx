...
const Footer = () => {
  return (
    <footer className="bg-[#f8fbff] text-gray-700 pt-24 pb-12 border-t border-sky-100">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-20 mb-24 items-start">
          ...
          <div className="bg-white/90 p-10 rounded-3xl border border-sky-100 shadow-sm">
            <h4 className="text-2xl font-bold mb-4 text-slate-900">Stay ahead of the curve.</h4>
            <p className="text-slate-600 mb-8">Get weekly market insights and strategy updates directly in your inbox.</p>
